...
export default function TaskForm({ onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md animate-fade-in">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg bg-slate-900 border border-slate-800 p-6 rounded-2xl shadow-2xl relative overflow-visible flex flex-col gap-5 text-left">
        <div>
